...
public class SpeedDistanceControll implements IController {
	...
	/**
	 * @return liefert die aktuelle Geschwindigkeit
	 */
	public float getSpeed() {
		if (this.distanceCalc != null)
			return this.distanceCalc.getSpeed();
		return 0;
	}
	
	public void updateSpeedScaler(float scaler) {
		this.distanceCalc.setScaler(scaler);
	}
	...
	public void updateSpeed(float speed) {
		...
		if (this.distanceCalc != null)
			this.distanceCalc.setSpeed(Math.abs(speed));
	}
